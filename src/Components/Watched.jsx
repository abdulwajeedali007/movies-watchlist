        ...
        <div>
            <div className="watchlist__container">
                <div className="image__wrappers">
                   ...
                   <div className="image__wrapper">
                      <img src="./images/The Villain.jpg" alt="joker"/>
                ...
                <div className="details__of__movies">
                   ...
                   <div className="total__watchlist_items">
                      <h2>Total watchlist movies - <span className="badge">{watched.length}</span></h2>
                   </div>
                </div>
                <div >
                    {watched.length > 0 ? (
                    ...
                    ): (<div className="notify">The watched is empty you need to add from movie list</div>)}
                </div>
            </div>
        </div>
    )
